...
void UIMap::out() 
{
	...
	win = SDL_CreateWindow("Image Loading", 100, 100, 640, 480, 0);
	renderer = SDL_CreateRenderer(win, -1, SDL_RENDERER_ACCELERATED);

	img = IMG_LoadTexture(renderer, "Resources/map.png");
	if(img = nullptr)
		std::cout << "img is pointing to null";
	SDL_QueryTexture(img, NULL, NULL, &w, &h);

	SDL_Rect texr; texr.x = 640/2; texr.y = 480/2; texr.w = w*2; texr.h = h*2;
...
void UIMap::update(MapObservable *aMap)
{
